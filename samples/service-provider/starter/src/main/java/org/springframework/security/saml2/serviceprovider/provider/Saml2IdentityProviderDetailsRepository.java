...
public interface Saml2IdentityProviderDetailsRepository {
	 ...
	 * @param spRequestUri - uri of the local application used to generate the local entityId, may be null
	 * @return a configured remote identity provider, or null if none found
	 */
	Saml2IdentityProviderDetails getIdentityProviderByEntityId(String idpEntityId, String spRequestUri);
	 ...
	 * @return a configured remote identity provider, or null if none found
	 */
	Saml2IdentityProviderDetails getIdentityProviderByAlias(String alias, String spRequestUri);
